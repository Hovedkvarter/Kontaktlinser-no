...
<title>{escape(product["name"])} • Sammenlign &amp; se billigste pris</title>
...
{_og_meta(f'{product["name"]} • Sammenlign & se billigste pris', long_description[:155], f'{BASE_URL}/kontaktlinser/{product["brand_slug"]}/{product["slug"]}/', image_url)}
{FONT_LINKS}
{schema_json_html}
{product_faq_schema}
<style>{SHARED_STYLE}
...
{_og_meta(f'{product["name"]} • Sammenlign & se billigste pris', long_description[:155], f'{BASE_URL}{base_url_path}', image_url)}
{FONT_LINKS}
{schema_json_html}
{product_faq_schema}
<style>{SHARED_STYLE}
